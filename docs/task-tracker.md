...
### Collagen Feature Section

**Completed:** 29 April 2026
**Branch:** `feature/mission` — ready to merge
**Spec:** `docs/features/mission-spec.md`

Full-viewport parallax feature card for Collagen product. Blurred/darkened `background-attachment: fixed` background, sharp card interior image with dark-to-transparent gradient fade, eyebrow label, headline, supporting copy, gold pill CTA, product PNG breaking out of card bottom. Built in playground.
